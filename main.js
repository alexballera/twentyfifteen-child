...
var lastsArticles = (0, _jquery2.default)(function () {
  // Variables Globales
  var $projectContainer = (0, _jquery2.default)('#lastArticles').find('.ul-articles');
  ...
  _jquery2.default.ajax('https://public-api.wordpress.com/rest/v1.1/sites/alexballera.com/posts/?number=5').then(function (lastArticles) {
    $projectContainer.find('.loader').remove();
...
var showCategories = (0, _jquery2.default)(function () {
  // Variables Globales
  var $projectContainer = (0, _jquery2.default)('#showCategories').find('.ul-categories');

  // Optimizamos con renderShows
  function renderShows(categories) {
    $projectContainer.find('.loader').remove();
    categories.categories.forEach(function (project) {
      var projectTemplate = template.replace(':title:', project.name).replace(':url:', project.slug);
  ...
  _jquery2.default.ajax('https://public-api.wordpress.com/rest/v1.1/sites/alexballera.com/categories/?number=5&order_by=count&order=DESC').then(function (categories) {
    $projectContainer.find('.loader').remove();
...
var showProjects = (0, _jquery2.default)(function () {
  ...
  function renderShows(projects) {
    ...
    projects.posts.forEach(function (project) {
      var projectTemplate = template.replace(':title:', project.title).replace(':url:', project.short_URL).replace(':link:', project.short_URL).replace(':link content:', project.short_URL).replace(':image:', project.featured_image).replace(':image alt:', project.title + ' Image').replace(':summary:', project.excerpt).replace(':author:', project.author.name).replace(':avatar:', project.author.avatar_URL).replace(':avatar alt:', project.author.name + ' Logo').replace(':profile:', project.author.profile_URL).replace(':profile img:', project.author.profile_URL).replace(':category:', project.categories.Proyectos.name).replace(':category2:', Object.keys(project.categories)[1]);
  ...
  _jquery2.default.ajax('https://public-api.wordpress.com/rest/v1.1/sites/alexballera.com/posts/?category=proyectos&number=6').then(function (projects) {
    $projectContainer.find('.loader').remove();
...
var _modernizr = require('./vendors/modernizr.js');

var _modernizr2 = _interopRequireDefault(_modernizr);

var _selectivizr = require('./vendors/selectivizr.js');

var _selectivizr2 = _interopRequireDefault(_selectivizr);

var _retina = require('./vendors/retina.js');

var _retina2 = _interopRequireDefault(_retina);

var _showMenu = require('./lib/showMenu');

var _showMenu2 = _interopRequireDefault(_showMenu);

var _changeButton = require('./lib/changeButton');
...
var _showProjects = require('./lib/showProjects');

var _showProjects2 = _interopRequireDefault(_showProjects);

var _showArticles = require('./lib/showArticles');

var _showArticles2 = _interopRequireDefault(_showArticles);

var _lastsArticles = require('./lib/lastsArticles');

var _lastsArticles2 = _interopRequireDefault(_lastsArticles);

var _showCategories = require('./lib/showCategories');
...
(function () {
  ...
  function onDOMLoad() {
    ...
    // Menú
    btnMenu.addEventListener('click', _showMenu2.default);
    navbarMenu.addEventListener('click', _showMenu2.default);
    btnButton.addEventListener('click', _showMenu2.default);
    btnButton.addEventListener('click', _changeButton2.default);
...
!function (window, document, undefined) {
  function is(A, e) {
    ...
    var A, e, t, n, r, o, i;for (var d in tests) {
      if (tests.hasOwnProperty(d)) {
        if (A = [], e = tests[d], e.name && (A.push(e.name.toLowerCase()), e.options && e.options.aliases && e.options.aliases.length)) for (t = 0; t < e.options.aliases.length; t++) {
          ...
          o = A[r], i = o.split("."), 1 === i.length ? Modernizr[i[0]] = n : (!Modernizr[i[0]] || Modernizr[i[0]] instanceof Boolean || (Modernizr[i[0]] = new Boolean(Modernizr[i[0]])), Modernizr[i[0]][i[1]] = n), classes.push((n ? "" : "no-") + i.join("-"));
        }
      }
    }
    ...
    var r,
      ...
      i = createElement("div"), i.id = n ? n[t] : a + (t + 1), s.appendChild(i);
    ...
    }for (var i, d, a, s, l, c = ["modernizr", "tspan"]; !mStyle.style;) {
    ...
    var o = A.charAt(0).toUpperCase() + A.slice(1),
        i = (A + " " + cssomPrefixes.join(o + " ") + o).split(" ");return is(e, "string") || is(e, "undefined") ? testProps(i, e, n, r) : (i = (A + " " + domPrefixes.join(o + " ") + o).split(" "), testDOMProps(i, e, t));
  }function testAllProps(A, e, t) {
    return testPropsAll(A, undefined, undefined, e, t);
  }var classes = [],
      tests = [],
      ModernizrProto = { _version: "3.2.0", _config: { classPrefix: "", enableClasses: !0, enableJSClass: !0, usePrefixes: !0 }, _q: [], on: function on(A, e) {
      ...
      Modernizr = function Modernizr() {};Modernizr.prototype = ModernizrProto, Modernizr = new Modernizr(), Modernizr.addTest("applicationcache", "applicationCache" in window), Modernizr.addTest("blobconstructor", function () {
    try {
      return !!new Blob();
    } catch (A) {
      return !1;
  ...
  }), Modernizr.addTest("eventsource", "EventSource" in window), Modernizr.addTest("fetch", "fetch" in window), Modernizr.addTest("xhr2", "XMLHttpRequest" in window && "withCredentials" in new XMLHttpRequest()), Modernizr.addTest("speechsynthesis", "SpeechSynthesisUtterance" in window), Modernizr.addTest("localstorage", function () {
    var A = "modernizr";try {
      return localStorage.setItem(A, A), localStorage.removeItem(A), !0;
    } catch (e) {
      return !1;
    }
  }), Modernizr.addTest("websqldatabase", "openDatabase" in window), Modernizr.addTest("sessionstorage", function () {
    var A = "modernizr";try {
    ...
    function t(A, e) {
      ...
      if (t || (t = e), c) return t.createElement(A);n || (n = o(t));var r;return r = n.cache[A] ? n.cache[A].cloneNode() : m.test(A) ? (n.cache[A] = n.createElem(A)).cloneNode() : n.createElem(A), !r.canHaveChildren || w.test(A) || r.tagUrn ? r : n.frag.appendChild(r);
    }function d(A, t) {
      if (A || (A = e), c) return A.createDocumentFragment();t = t || o(A);for (var r = t.frag.cloneNode(), i = 0, d = n(), a = d.length; a > i; i++) {
        r.createElement(d[i]);
      }return r;
    }function a(A, e) {
      ...
      A || (A = e);var n = o(A);return !h.shivCSS || l || n.hasCSS || (n.hasCSS = !!t(A, "article,aside,dialog,figcaption,figure,footer,header,hgroup,main,nav,section{display:block}mark{background:#FF0;color:#000}template{display:none}")), c || a(A, n), A;
    }var l,
        c,
        u = "3.7.3",
        p = A.html5 || {},
    ...
    }();var h = { elements: p.elements || "abbr article aside audio bdi canvas data datalist details dialog figcaption figure footer header hgroup main mark meter nav output picture progress section summary template time video", version: u, shivCSS: p.shivCSS !== !1, supportsUnknownElements: c, shivMethods: p.shivMethods !== !1, type: "default", shivDocument: s, createElement: i, createDocumentFragment: d, addElements: r };A.html5 = h, s(e), "object" == (typeof module === "undefined" ? "undefined" : _typeof(module)) && module.exports && (module.exports = h);
    ...
    function A(A, e, t) {
      function n(e) {
        var n = e && "load" === e.type ? 1 == r.width : !1,
            o = "webp" === A;addTest(A, o ? new Boolean(n) : n), t && t(e);
      ...
      if (t && "load" === t.type) for (var n = 0; n < e.length; n++) {
        A(e[n].name, e[n].uri);
      }
    });
    ...
    function A() {
      ...
      } catch (c) {}r || (o = new t(), o.append(l), r = o.getBlob()), d = n.createObjectURL(r), i = new Worker(d), i.onmessage = function (A) {
    ...
    var t = !1,
        n = createElement("div"),
        r = n.style;if (A in r) {
      var o = domPrefixes.length;for (r[A] = e, t = r[A]; o-- && !t;) {
    ...
    var A,
        e = createElement("div"),
        t = !1;return isSVG || (e.innerHTML = '<v:shape id="vml_flag1" adj="1" />', A = e.firstChild, A.style.behavior = "url(#default#VML)", t = A ? "object" == _typeof(A.adj) : !0), t;
    ...
    }Modernizr._config.usePrefixes && (n += e + "-webkit-" + t);var i = createElement("a"),
        d = i.style;return d.cssText = n, ("" + d.backgroundImage).indexOf("gradient") > -1;
    ...
    if (isSVG) return !1;var A = Modernizr.prefixed("flowFrom"),
        ...
        o = createElement("div"),
        i = createElement("div"),
        d = "modernizr_flow_for_regions_check";o.innerText = "M", r.style.cssText = "top: 150px; left: 150px; padding: 0px;", i.style.cssText = "width: 50px; height: 50px; padding: 42px;", i.style[A] = d, r.appendChild(o), r.appendChild(i), docElement.appendChild(r);var a,
        s,
        l = o.getBoundingClientRect();return o.style[e] = d, a = o.getBoundingClientRect(), s = parseInt(a.left - l.left, 10), docElement.removeChild(r), 42 == s ? t = !0 : (docElement.appendChild(n), l = n.getBoundingClientRect(), n.style[e] = d, a = n.getBoundingClientRect(), l.height > 0 && l.height !== a.height && 0 === a.height && (t = !0)), o = i = r = n = undefined, t;
    ...
    function A(A, e) {
      ...
      docElement.removeChild(t), t = null, n = null, r = null;
        ...
        r = createElement("rp"),
        o = "display",
        i = "fontSize";return t.appendChild(r), t.appendChild(n), docElement.appendChild(t), "none" == A(r, o) || "ruby" == A(t, o) && "ruby-text" == A(n, o) || "6pt" == A(r, i) && "6pt" == A(n, i) ? (e(), !0) : (e(), !1);
    ...
    var A = createElement("input"),
        e = "directory";if (A.type = "file", e in A) return !0;for (var t = 0, n = domPrefixes.length; n > t; t++) {
    ...
    var A,
        ...
        t,
        n = createElement("img"),
        r = "sizes" in n;!r && "srcset" in n ? (e = "data:image/gif;base64,R0lGODlhAgABAPAAAP///wAAACH5BAAAAAAALAAAAAACAAEAAAICBAoAOw==", A = "data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==", t = function t() {
    ...
    if (Modernizr.webglextensions = new Boolean(!1), Modernizr.webgl) {
      var A, e, t;try {
        ...
        return;
      }e !== undefined && (Modernizr.webglextensions = new Boolean(!0));for (var r = -1, o = t.length; ++r < o;) {
    ...
    } catch (o) {}if (A = !("plugins" in navigator && "Shockwave Flash" in navigator.plugins || e), A || isSVG) r(!1);else {
      var _i,
          d,
          a = createElement("embed"),
          s = getBody();if (a.type = "application/x-shockwave-flash", s.appendChild(a), !("Pan" in a || e)) return t(s), r("blocked", a), void n(s);_i = function i() {
        return t(s), docElement.contains(s) ? (docElement.contains(a) ? (d = a.style.cssText, "" !== d ? r("blocked", a) : r(!0, a)) : r("blocked"), void n(s)) : (s = document.body || s, a = createElement("embed"), a.type = "application/x-shockwave-flash", s.appendChild(a), setTimeout(_i, 1e3));
      }, setTimeout(_i, 10);
    }
  });var mq = function () {
    ...
    var t = document.getElementById("smodernizr"),
        ...
        o = /src/i.test(r) && 0 === r.indexOf(e.split(" ")[0]);Modernizr.addTest("fontface", o);
    ...
    var A,
      ...
      var t = document.createEvent("KeyboardEvent");A = !1;var n = function n(e) {
    ...
    }, !1), A.innerHTML = '<input name="modTest" required><button></button>', testStyles("#modernizr form{position:absolute;top:-99999em}", function (n) {
    ...
    for (var e, t, n, r = A.length, o = "1)", i = 0; r > i; i++) {
      inputElem.setAttribute("type", e = A[i]), n = "text" !== inputElem.type && "style" in inputElem, n && (inputElem.value = o, inputElem.style.cssText = "position:absolute;visibility:hidden;", /^range$/.test(e) && inputElem.style.WebkitAppearance !== undefined ? (docElement.appendChild(inputElem), t = document.defaultView, n = t.getComputedStyle && "textfield" !== t.getComputedStyle(inputElem, null).WebkitAppearance && 0 !== inputElem.offsetHeight, docElement.removeChild(inputElem)) : /^(search|tel)$/.test(e) || (n = /^(url|email)$/.test(e) ? inputElem.checkValidity && inputElem.checkValidity() === !1 : inputElem.value != o)), inputs[A[i]] = !!n;
    }return inputs;
    ...
    } catch (o) {}return A = "number" === r.type && 1.1 === r.valueAsNumber && r.checkValidity(), n.removeChild(e), t.fake && n.parentNode.removeChild(n), A;
    ...
    var e,
      ...
      var o = prefixes[r],
          i = o.toUpperCase() + "_" + e;if (i in n) return "@-" + o.toLowerCase() + "-" + A;
    }return !1;
  };ModernizrProto.atRule = atRule;var modElem = { elem: createElement("modernizr") };Modernizr._q.push(function () {
    delete modElem.elem;
  ...
  }, 3);var testXhrType = function testXhrType(A) {
  ...
  }), Modernizr.addTest("fullscreen", !(!prefixed("exitFullscreen", document, !1) && !prefixed("cancelFullScreen", document, !1))), Modernizr.addTest("gamepads", !!prefixed("getGamepads", navigator));var indexeddb = prefixed("indexedDB", window);Modernizr.addTest("indexeddb", !!indexeddb), indexeddb && Modernizr.addTest("indexeddb.deletedatabase", "deleteDatabase" in indexeddb), Modernizr.addAsyncTest(function () {
    var A,
        e,
        t = prefixed("indexedDB", window),
        n = "detect-blob-support",
        r = !1;if (!Modernizr.indexeddb || !Modernizr.indexeddb.deleteDatabase) return !1;try {
    ...
    var A = prefixed("wrapFlow");if (!A || isSVG) return !1;var e = A.replace(/([A-Z])/g, function (A, e) {
      return "-" + e.toLowerCase();
        ...
        t = createElement("div"),
        n = createElement("div"),
        r = createElement("span");n.style.cssText = "position: absolute; left: 50px; width: 100px; height: 20px;" + e + ":end;", r.innerText = "X", t.appendChild(n), t.appendChild(r), docElement.appendChild(t);var o = r.offsetLeft;return docElement.removeChild(t), n = r = t = undefined, 150 == o;
      ...
      function t() {
        ...
        try {
          var t = createElement("div"),
              ...
              d = !1,
              a = !1,
              s = document.body.firstElementChild || document.body.firstChild;return r.cssText = "position:absolute;top:0;left:0;overflow:visible;width:1.25em;", t.appendChild(n), document.body.insertBefore(t, s), n.innerHTML = "mm", o = n.offsetHeight, n.innerHTML = "m" + A + "m", d = n.offsetHeight > o, e ? (n.innerHTML = "m<br />m", o = n.offsetWidth, n.innerHTML = "m" + A + "m", a = n.offsetWidth > o) : a = !0, d === !0 && a === !0 && (i = !0), document.body.removeChild(t), t.removeChild(n), i;
        } catch (l) {
          return !1;
        }
      }function r(A) {
        try {
          var e,
              ...
              r = "lebowski",
              o = !1,
              i = document.body.firstElementChild || document.body.firstChild;n.innerHTML = r + A + r, document.body.insertBefore(n, i), document.body.insertBefore(t, n), t.setSelectionRange ? (t.focus(), t.setSelectionRange(0, 0)) : t.createTextRange && (e = t.createTextRange(), e.collapse(!0), e.moveEnd("character", 0), e.moveStart("character", 0), e.select());try {
  ...
  }), Modernizr.addTest("userselect", testAllProps("userSelect", "none", !0)), testRunner(), setClasses(classes), delete ModernizrProto.addTest, delete ModernizrProto.addAsyncTest;for (var i = 0; i < Modernizr._q.length; i++) {
    Modernizr._q[i]();
	...
	function patchPseudoClass(pseudo) {
		...
		if (pseudo.charAt(0) == ":") {
			switch (pseudo.slice(1)) {
				...
				case "root":
					applyClass = function applyClass(e) {
